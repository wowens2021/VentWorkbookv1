  ...
  return (
    <div className="h-full flex flex-col px-5 py-4 overflow-y-auto">
      <div className="flex items-center gap-2 mb-3">
        <Sparkles size={16} className="text-brand-olive" />
        <h2 className="font-display text-xl font-semibold text-zinc-900 leading-tight">
      ...
      <div className="mt-auto flex items-center gap-2 pt-4 border-t border-zinc-200">
        <button
          onClick={onReset}
          className="flex items-center gap-1.5 px-3 py-2 bg-white border border-zinc-300 hover:bg-stone-50 rounded-lg text-[12px] font-bold text-zinc-700 transition"
        >
        ...
        <button
          ...
          className="ml-auto flex items-center gap-1.5 px-4 py-2 bg-brand-olive hover:bg-brand-olive-hover text-white rounded-lg text-sm font-bold transition shadow-sm"
        >
