...
const ModuleShell: React.FC<Props> = ({ module, onBack, onNext, onHome, nextModule }) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-brand-olive/25 via-brand-olive/15 to-brand-olive/30 text-zinc-900 font-sans overflow-hidden select-none">
