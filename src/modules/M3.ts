...
export const M3: ModuleConfig = {
  ...
  primer_questions: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'PIP rises.', is_correct: true, explanation: 'More volume into the same compliance means a higher alveolar pressure, and a higher peak.' },
  ...
  summative_quiz: [
    ...
    },
    {
      ...
      options: [
        { label: 'About 27', is_correct: true, explanation: 'PEEP raises the floor; PIP rises by roughly the same amount. They\'re additive.' },
